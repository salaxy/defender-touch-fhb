package de.fhb.defenderTouch.eingabetests;
...
public class EingabeTestsPApplet extends PApplet {
...
//	     rect(-obj_size/2,-obj_size/2,obj_size,obj_size); //draw rectangle
    ...
    static public void main(String args[]) {
        PApplet.main(new String[] { "de.fhb.defenderTouch.eingabetests.EingabeTestsPApplet" });
    }
