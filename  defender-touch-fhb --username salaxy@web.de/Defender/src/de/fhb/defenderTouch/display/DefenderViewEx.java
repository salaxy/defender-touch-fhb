...
public class DefenderViewEx extends PApplet {
...
//	     rect(-obj_size/2,-obj_size/2,obj_size,obj_size); //draw rectangle
    ...
    static public void main(String args[]) {
        PApplet.main(new String[] { "de.fhb.defenderTouch.display.DefenderViewEx" });
    }
    ...
    public void mouseDragged() {
    	if (mouseButton == LEFT) {
    		if (mouseX < 512) {
    			PVector tempVec = spielerOne.getSichtPosition();
    			tempVec.x += mouseX - pmouseX;
    			tempVec.y += mouseY - pmouseY;
    		} else {
    			PVector tempVec = spielerTwo.getSichtPosition();
    			tempVec.x += mouseX - pmouseX;
    			tempVec.y += mouseY - pmouseY;
    		}
    	}
